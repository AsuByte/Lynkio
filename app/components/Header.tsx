...
const Header = () => {
  return (
    <header className="w-full bg-(--color-background) px-4 sm:px-6 py-4 flex items-center justify-between">
      <div className="flex-1"></div>

      <div className="flex justify-center flex-1 min-w-0 items-center">
        <Link
          href="/"
          className={`${luckiest.className} text-(--color-accent) text-3xl sm:text-3xl md:text-4xl 
